    ...
    var dzSparkLine = function() {
                ...
                new Chart(barChart_1, {
                    ...
                    data: {
                        ...
                        datasets: [{
                            ...
                            data: [prod1, prod2, prod3, prod4, prod5, prod6, prod7, prod8],
        ...
        var barChart_forFemaleStat = function() {
            if (jQuery('#barChart_forFemaleStat').length > 0) {
                // alert(1);
                const ForFemales = document.getElementById("barChart_forFemaleStat").getContext('2d');
                ...
                new Chart(ForFemales, {
                    ...
                    data: {
                        defaultFontFamily: 'Poppins',
                        // labels: ["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sept", "Oct", "NOv", "Dec"],
                        labels: [GenderFemaleKey1, GenderFemaleKey2, GenderFemaleKey3, GenderFemaleKey4, GenderFemaleKey5, GenderFemaleKey6],
                        datasets: [{
                            label: "Active Female Users",
                            // data: [65, 59, 80, 81, 56, 55, 40, 80, 81, 56, 55, 40],
                            data: [GenderFemaleValue1, GenderFemaleValue2, GenderFemaleValue3, GenderFemaleValue4, GenderFemaleValue5, GenderFemaleValue6],
                            borderColor: 'rgba(11, 42, 151, 1)',
                            borderWidth: "0",
                            backgroundColor: 'rgba(11, 42, 151, 1)'
                        }]
        ...
        var barChart_forMaleStat = function() {
            if (jQuery('#barChart_forMaleStat').length > 0) {
                // alert(1);
                const forMales = document.getElementById("barChart_forMaleStat").getContext('2d');
                ...
                new Chart(forMales, {
                    ...
                    data: {
                        defaultFontFamily: 'Poppins',
                        // labels: ["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sept", "Oct", "NOv", "Dec"],
                        labels: [GenderMaleKey1, GenderMaleKey2, GenderMaleKey3, GenderMaleKey4, GenderMaleKey5, GenderMaleKey6],
                        datasets: [{
                            label: "Active Male Users",
                            // data: [65, 59, 80, 81, 56, 55, 40, 80, 81, 56, 55, 40],
                            data: [GenderMaleValue1, GenderMaleValue2, GenderMaleValue3, GenderMaleValue4, GenderMaleValue5, GenderMaleValue6],
                            borderColor: 'rgba(11, 42, 151, 1)',
                            borderWidth: "0",
                            backgroundColor: 'rgba(11, 42, 151, 1)'
                        }]
