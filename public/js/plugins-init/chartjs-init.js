(function($) {
    ...
    var dzSparkLine = (function() {
        ...
        var barChart_forFemaleStat = function() {
            if (jQuery("#barChart_forFemaleStat").length > 0) {
                // alert(1);
                const ForFemales = document
                    .getElementById("barChart_forFemaleStat")
                    .getContext("2d");

                ForFemales.height = 100;

                new Chart(ForFemales, {
                    type: "bar",
                    data: {
                        defaultFontFamily: "Poppins",
                        // labels: ["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sept", "Oct", "NOv", "Dec"],
        ...
        var barChart_forMaleStat = function() {
            if (jQuery("#barChart_forMaleStat").length > 0) {
                // alert(1);
                const forMales = document
                    .getElementById("barChart_forMaleStat")
                    .getContext("2d");
        ...
        var barChart2 = function() {
            if (jQuery("#barChart_2").length > 0) {
                ...
                const barChart_2 = document
                    ...
                    .getContext("2d");
                //generate gradient
                const barChart_2gradientStroke =
                    barChart_2.createLinearGradient(0, 0, 0, 250);
                barChart_2gradientStroke.addColorStop(
                    0,
                    "rgba(11, 42, 151, 1)"
                );
                barChart_2gradientStroke.addColorStop(
        ...
        var barChart3 = function() {
            ...
            if (jQuery("#barChart_3").length > 0) {
                const barChart_3 = document
                    ...
                    .getContext("2d");
                //generate gradient
                const barChart_3gradientStroke =
                    barChart_3.createLinearGradient(50, 100, 50, 50);
                barChart_3gradientStroke.addColorStop(
                    0,
                    "rgba(11, 42, 151, 1)"
                );
                barChart_3gradientStroke.addColorStop(
                ...
                const barChart_3gradientStroke2 =
                    barChart_3.createLinearGradient(50, 100, 50, 50);
                barChart_3gradientStroke2.addColorStop(
                    0,
                    "rgba(39, 188, 72, 1)"
                );
                barChart_3gradientStroke2.addColorStop(
                ...
                const barChart_3gradientStroke3 =
                    barChart_3.createLinearGradient(50, 100, 50, 50);
                barChart_3gradientStroke3.addColorStop(
                    0,
                    "rgba(139, 199, 64, 1)"
                );
                barChart_3gradientStroke3.addColorStop(
        ...
        var lineChart2 = function() {
            ...
            if (jQuery("#lineChart_2").length > 0) {
                const lineChart_2 = document
                    ...
                    .getContext("2d");
                //generate gradient
                const lineChart_2gradientStroke =
                    lineChart_2.createLinearGradient(500, 0, 100, 0);
                lineChart_2gradientStroke.addColorStop(
                    0,
                    "rgba(11, 42, 151, 1)"
                );
                lineChart_2gradientStroke.addColorStop(
        ...
        var lineChart3 = function() {
            ...
            if (jQuery("#lineChart_3").length > 0) {
                ...
                const lineChart_3gradientStroke1 =
                    lineChart_3.createLinearGradient(500, 0, 100, 0);
        ...
        var radarChart = function() {
            if (jQuery("#radar_chart").length > 0) {
                ...
                const radar_chartgradientStroke1 =
                    radar_chart.createLinearGradient(500, 0, 100, 0);
                radar_chartgradientStroke1.addColorStop(
                    0,
                    "rgba(54, 185, 216, .5)"
                );
                radar_chartgradientStroke1.addColorStop(
                ...
                const radar_chartgradientStroke2 =
                    radar_chart.createLinearGradient(500, 0, 100, 0);
                radar_chartgradientStroke2.addColorStop(
                    0,
                    "rgba(68, 0, 235, .5"
                );
                radar_chartgradientStroke2.addColorStop(
        ...
        return {
            ...
            load: function() {
                barChart1();
                barChart_forMaleStat();
                barChart_forFemaleStat();
                barChart2();
                barChart3();
                lineChart1();
                lineChart2();
