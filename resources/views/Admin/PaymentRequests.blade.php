                            ...
                            <table id="example123" class="display min-w850">
                                ...
                                <tbody>
                                    ...
                                    <tr class="photo" data-id="1" id="photo_1">
                                        ...
                                        <td id="acc_number_1">8421368412389614</td>
                                        <td id="bank_1">Meezan Bank</td>
                                        ...
                                        <td>
                                             {{-- <button class="btn btn-sm btn-success" data-id="1">Approve</button> --}}

                                             {{-- <a style="" class="this_anchor_for_modal_open" href="#" data-id="1"
                                                onclick="view_user(this)" data-toggle="modal"
                                                data-target="#basicModal"> <button class="btn btn-sm btn-success"> Approve </button></a>   --}}

                                             <a style="" class="this_anchor_for_modal_open" href="#" data-id="1"
                                                onclick="view_user(this)" data-toggle="modal"
                                                data-target="#basicModal"> <button class="btn btn-sm btn-danger"> Requested </button></a>  

                                             {{-- <button class="btn btn-sm btn-danger">Decline</button> </td> --}}
