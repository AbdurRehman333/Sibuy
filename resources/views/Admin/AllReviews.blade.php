                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            ...
                            <div style="margin-top: 10px;">
                                ...
                                <form action="{{url('AdminAllReviewsFilterUsers')}}" method="GET" style="display: table-cell;">
                            ...
                            <table id="example4" class="display min-w850">
                                ...
                                <tbody>
                                    ...
                                    @php
                                     $count = count($reviews);
                                    //  $min_date = Carbon::parse($fromDate)->format('Y-m-d');
                                    //  $max_date = Carbon::parse($toDate)->format('Y-m-d')
                                    @endphp
                                    ...
                                    @if($from_filter == 0)
                                        ...
                                        @for($i = $count-1; $i >= 0; $i--)
                                            ...
                                            @php
                                                // $review_date = Carbon::parse($reviews[$i]['created_at'])->format('Y-m-d');
                                            ...
                                            <tr>
                                                ...
                                                @else
                                                    ...
                                                    @else
                                                        ...
                                                        <td style="">
                                                            <div style="font-weight: bold;">
                                                                Replied to {{$reviews[$i]['replied_to']}} </td>
                                                            </div>
                                                        @endif
                                                    @endif
                                                ...
                                                @if($reviews[$i]['deal_name'])
                                                    <td> <a href="{{url('OfferDetails/'.$reviews[$i]['deal_id'])}}">{{$reviews[$i]['deal_name']}}</a> </td>
                                                @else
                                                    <td>N/A</td>
                                                @endif
                                                
                                                <td> <a href="{{url('AdminMerchantProfile/'.$reviews[$i]['merchant_name'])}}">{{$reviews[$i]['merchant_name']}}</a> </td>
                                                <td> {{Carbon\Carbon::parse($reviews[$i]['created_at'])->format('d F Y')}}</td>
                                                
                                                @if($reviews[$i]['deal_name'])
                                                <td> <a class="btn btn-sm btn-primary" style="color: #f5f5f5 !important;" href="{{url('AdminEditReview/'.$reviews[$i]['id'])}}"  >Edit</a> </td>
                                    ...
                                    <tr>
                                        ...
                                        <td> <a href="{{url('AdminMerchantProfile/'.$review['merchant_name'])}}">{{$review['merchant_name']}}</a> </td>
