...
<style>
    .stat_boxes::-webkit-scrollbar {
    width: 0.2em;
    }
    
    .stat_boxes::-webkit-scrollbar-track {
    box-shadow: inset 0 0 6px rgba(0, 0, 0, 0.3);
    }
    
    .stat_boxes::-webkit-scrollbar-thumb {
...
<div class="content-body">
    ...
    <div class="container-fluid">
        <div class="row">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="card avtivity-card">
                            <div class="card-body">
                                <a href="{{url('ActiveMerchants')}}">
                                <div class="media align-items-center">
                                    
                                        <span class="activity-icon bgl-success mr-md-4 mr-3" style="background: #fefaf0;">

                                            <i class="fa fa-users" aria-hidden="true"
                                                style="font-size:35px;margin-top:23px;"></i>
    
                                        </span>
                                        <div class="media-body">
                                            <p class="fs-14 mb-2">Total Active Merchants</p>
                                            <span
                                                class="title text-black font-w600">{{$basic_stats['totalActiveMerchants']}}</span>
                                        </div>
                                    </div>
                                </a>
                    ...
                    <div class="col-sm-6">
                        <div class="card avtivity-card">
                            <div class="card-body">
                                ...
                                <a href="{{url('AdminCoupons')}}">
                                <div class="media align-items-center">
                                    <span class="activity-icon bgl-secondary  mr-md-4 mr-3" style="background: #fefee8;">
                                    ...
                                    <div class="media-body">
                                        <p class="fs-14 mb-2">Total Active Deals</p>
                                        <span
                                            class="title text-black font-w600">{{$basic_stats['totalActiveDeals']}}</span>
                                    </div>
                                </div>
                                </a>
                                {{-- <div class="progress" style="height:5px;">
                    ...
                    <div class="col-sm-6">
                        <div class="card avtivity-card">
                            <div class="card-body">
                                <a href="{{url('AdminRedeemedDealsStats')}}">
                                <div class="media align-items-center">
                                    <span class="activity-icon bgl-danger mr-md-4 mr-3" style="background: #fff9cd;">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <p class="fs-14 mb-2">Redeemed Deals</p>
                                        <span
                                            class="title text-black font-w600">{{$basic_stats['totalDealRadeem']}}</span>
                                    </div>
                                </div>
                                </a>
                                {{-- <div class="progress" style="height:5px;">
                    ...
                    <div class="col-sm-6">
                        <div class="card avtivity-card">
                            <div class="card-body">
                                ...
                                <a href="{{url('AdminAllUsers')}}">
                                <div class="media align-items-center">
                                    <span class="activity-icon bgl-warning  mr-md-4 mr-3" style="background: #f5efc8;">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <span
                                            class="title text-black font-w600">{{$basic_stats['totalActiveUsers']}}</span>
                                    </div>
                                </div>
                                </a>
                                {{-- <div class="progress" style="height:5px;">
            ...
            <div class="col-xl-6 col-xxl-12">
                <div class="card">
                    {{-- href="{{url('AdminAllUsers')}}" --}}
                    <a href="{{url('AdminAllUsers')}}">
                        <div class="card-header d-sm-flex d-block pb-0 border-0">
                            <div class="mr-auto pr-3 mb-sm-0 mb-3">
                                <h4 class="text-black fs-20">Active Users Analytics</h4>
                            ...
                            <div class="dropdown mb-3 show">
                                ...
                                {{-- <div class="dropdown-menu dropdown-menu-right">
                                    <a class="dropdown-item" href="javascript:void(0);">June 2022</a>
                                    <a class="dropdown-item" href="javascript:void(0);">May 2022</a>
                                </div> --}}
                            </div>
                        </div>
                    </a>
                            ...
                            <div class="card-body">
                                ...
                                <div class="media align-items-center">
                                        ...
                                        <div class="media-body">
                                            ...
                                            <span
                                                class="title text-black font-w600">{{$basic_stats['totalTransactions']}}</span>
                                        </div>
                                    </div>
                                </a>
                            ...
                            <div class="card-body">
                                ...
                                <div class="media align-items-center">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <span
                                            class="title text-black font-w600">${{$basic_stats['totalTransactionFee']}}</span>
                                    </div>
                                </div>
                                </a>
                                {{-- <div class="progress" style="height:5px;">
                        ...
                        <div class="card avtivity-card">
                            <div class="card-body">
                                ...
                                <div class="media align-items-center">
                                        ...
                                        <div class="media-body">
                                            <p class="fs-14 mb-2">Total Transacted Amount</p>
                                            <span
                                                class="title text-black font-w600">${{$basic_stats['totalTransactionAmount']}}</span>
                                        </div>
                                    </div>
                                </a>
                                {{-- <div class="progress" style="height:5px;">
                            ...
                            <div class="card-body">
                                ...
                                <div class="media align-items-center">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <span
                                            class="title text-black font-w600">${{$basic_stats['totalUnredeemedWithHolding']}}</span>
                                    </div>
                                </div>
                                </a>
                                {{-- <div class="progress" style="height:5px;">
                        ...
                        <div class="card avtivity-card">
                            <div class="card-body">
                                ...
                                <div class="media align-items-center">
                                    ...
                                    <div class="media-body">
                                        <p class="fs-14 mb-2">Total Unredeemed Earning</p>
                                        <span
                                            class="title text-black font-w600">${{$basic_stats['totalUnredeemedEarning']}}</span>
                                    </div>
                                </div>
                                </a>
                                {{-- <div class="progress" style="height:5px;">
                        ...
                        <div class="card avtivity-card">
                            <div class="card-body">
                                ...
                                <div class="media align-items-center">
                                    ...
                                    <div class="media-body">
                                        <p class="fs-14 mb-2">Total Commission Earned</p>
                                        <span
                                            class="title text-black font-w600">${{$basic_stats['totalCommissionEarned']}}</span>
                                    </div>
                                </div>
                                </a>
                                {{-- <div class="progress" style="height:5px;">
                        ...
                        <div class="card avtivity-card">
                            <div class="card-body">
                                ...
                                <div class="media align-items-center">
                                    ...
                                    <div class="media-body">
                                        <p class="fs-14 mb-2">Total Service Charges</p>
                                        <span
                                            class="title text-black font-w600">${{$basic_stats['totalServiceCharges']}}</span>
                                    </div>
                                </div>
                                </a>
                                {{-- <div class="progress" style="height:5px;">
                        ...
                        <div class="card avtivity-card">
                            <div class="card-body">
                                ...
                                <div class="media align-items-center">
                                    ...
                                    <div class="media-body">
                                        <p class="fs-14 mb-2">Total Redeemed Earning</p>
                                        <span
                                            class="title text-black font-w600">${{$basic_stats['totalRedeemedEarning']}}</span>
                                    </div>
                                </div>
                                </a>
                                {{-- <div class="progress" style="height:5px;">
                                    ...
                                    <div class="items">
                                        <div class="card text-center">
                                            <div class="card-body">
                                                ...
                                                @else
                                                <img src="{{''.config('path.path.WebPath').''.$M['profilePicturePath'].'/'.$M['profile_picture'].''}}" alt="">
                                                @endif

                                                <h5 class="fs-16 font-w500 mb-1"><a
                                                        href="{{URL('AdminMerchantProfile/'.$M['id'])}}"
                                                        class="text-black">{{$M['name']}}</a></h5>
                                                ...
                                                <div class="d-flex align-items-center justify-content-center">
                                                    ...
                                                    {{-- <a href="app-profile.html" class="btn-link fs-14">Send
                                                        Request</a> --}}
                                                    <a href="{{URL('AdminMerchantProfile/'.$M['id'])}}"
                                                        class="btn-link fs-14">Trending</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="col-xl-12">
                        <div class="card">
                            ...
                            <div class="col-xl-12 col-lg-12 col-sm-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h4 class="card-title"><a href="{{url('AdminPurchaseDealsStats')}}">Purchased Deals</a></h4>
                                    </div>
                                    <div class="card-body">
                                        <canvas id="barChart_1"></canvas>
                                    </div>
                            ...
                            {{-- <div class="card-header d-sm-flex d-block pb-0 border-0">
                                <div class="mr-auto pr-3">
                                    <h4 class="text-black fs-20 font-w600">Categories Chart</h4>
                                    <p class="fs-13 mb-0 text-black">Lorem ipsum dolor sit amet, consectetur</p>
                                </div>
            ...
            {{-- col-xl-4 col-xxl-12 col-lg-12 --}}
            <div class="col-xl-3 col-xxl-4">
                <div class="row">
                    <div class="col-xl-12">
                        <div class="card featuredMenu">
                            <div class="card-header border-0">
                                <h4 class="text-black font-w600 fs-20 mb-0">Top Trending Discounts</h4>
                            </div>
                            <div class="card-body loadmore-content height750 dz-scroll pt-0" id="FeaturedMenusContent">
                                ...
                                <div class="media mb-4">
                                    {{-- <img src="{{''.config('path.path.WebPath').''.$D['images'][0]['path'].'/'.$D['images'][0]['image'].''}}" width="85" alt="" class="rounded mr-3"> --}}

                                    @if($D['image'])
                                    <img src="{{config('path.path.WebPath').'/'.config('path.path.DealsPath').'/'.$D['image']['image']}}" width="85" alt="" class="rounded mr-3">
                                    @else
                                    ...
                                    <div class="media-body">
                                        <h5><a href="{{url('OfferDetails/'.$D['id'])}}" class="text-black fs-16">{{$D['name']}}</a></h5>


                                        @if($D['type'] == 'Entire Menu')
                                        ...
                                        @endif
                                                ...
                                                @php
                                                    ...
                                                    $expiry = $D['additional_discount_date'];
                                        ...
                                        {{-- <span class="fs-14 text-primary font-w500" style="font-size:1rem !important;">
                                            {{$percent_to_give}}% </span> --}}

                                        {{-- @if($D['additional_discount'] > 0 && $result )

                                            @php
                                            $price_to_pay_in_double_discount = $D['price'] - ($D['price'] * ($D['additional_discount'] / 100) )
                                            @endphp
                                        ...
                                        @else --}}
                                            ...
                                            {{-- @php
                                                $percent_to_give =  $D['price'] - ($D['price'] * ( $D['discount_on_price'] / 100  ))
                                            @endphp
                                ...
                                <ul class="d-flex flex-wrap pb-2 border-bottom mb-3 justify-content-between">
                                    <li class="mr-3 mb-2"><span class="fs-14 text-black"
                                            style="    font-size: 11px !important;">{{$D['totalRadeems']}} Deals
                                            Redeemed </span></li>
                                    <li class="mb-2"><i class="fa fa-star-o mr-3 scale5 text-warning"
                                            aria-hidden="true"></i><span
                                            class="fs-14 text-black font-w500">{{$D['totalReviews']}} Reviews</span>
                                    </li>
                                </ul>
                                @endforeach
                                {{-- <div class="media mb-4">
                                ...
                                <ul class="d-flex flex-wrap pb-2 border-bottom mb-3 justify-content-between">
                                    <li class="mr-3 mb-2"><span class="fs-14 text-black"
                                            style="    font-size: 11px !important;">44 Coupons Redeemed </span></li>
                                    <li class="mb-2"><i class="fa fa-star-o mr-3 scale5 text-warning"
                            ...
                            {{-- <div class="card-footer style-1 text-center border-0 pt-0 pb-4">
                                <a class="text-primary dz-load-more fa fa-chevron-down" id="FeaturedMenus"
                                    href="javascript:void(0);" rel="ajax/featured-menu-list.blade.php">
                                </a>
        ...
        <div class="row">
            ...
            <div class="col-xl-4 ">
                <div class="card overflow-hidden">
                    <div class="card-header">
                        <h4 class="card-title">Top Active Pages</h4>
                    </div>
                    <div class="card-body stat_boxes" style="max-height: 420px;
                        overflow-y: scroll;">
                        ...
                        {{-- <div style="margin-top:1rem;">
                            <span id="">Top Active Pages</span> <span style="float: right;" id="">Active Users</span>
                        </div> --}}
                        <div style="margin-top:1rem;" class="">

                            @if(count($mostSearch) < 5)
                            @foreach($mostSearch['data'] as $key => $m)
                                <span id="">{{$key}}</span> <span style="float: right;" id="">{{$m}}</span>
                                <hr>
                            @endforeach
                            @else
                            ...
                            {{-- <span id="">/Home/</span> <span style="float: right;" id="">51</span>
                            <hr>
                            <span id="">/Deals/SPA</span> <span style="float: right;" id="">23</span>
                            <hr>
                            <span id="">/Deals/SPA</span> <span style="float: right;" id="">23</span>
                            <hr>
                            <span id="">/Deals/SPA</span> <span style="float: right;" id="">23</span>
                            <hr>
                            <span id="">/Tags/Merchants/</span> <span style="float: right;" id="">13</span> --}}
            ...
            <div class="col-xl-4">
                <div class="card ">
                    <div class="card-header">
                        <h5 class="card-title ">Most Searched Terms</h5>
                    </div>

                    <div style="max-height: 420px;
                        overflow-y: scroll;" class="card-body mb-0 stat_boxes">

                        {{-- <p>Lorem ipsum dole vero ut deleniti dolorum quia doloremque illum harum veniam explicabo quis?
                        </p> --}}

                        @foreach($searchTerms as $key => $value)
                            <span id="">{{$value['term']}}</span> <span style="float: right;" id="">{{$value['term_count']}} times</span>
                            <hr>
                            @php
                                if($key == 9)
                                {
                    ...
                    {{-- <div class="card-body mb-0">
                        <p class="card-text">Some quick example text to build on the card title and make up the bulk of
                            the card's content.</p><a href="javascript:void()" class="btn btn-primary light btn-card">Go
                            somewhere</a>
                    </div> --}}
                    {{-- <div class="card-footer bg-transparent border-0" style="align-self: center;"><a
                            style="color: #000000 !important; font-weight: 500;"
                            href="{{route('AdminAllCategories')}}">View All</a></div> --}}
                </div>
            </div>
            ...
            <div class="col-xl-4">
                <div class="card text-white bg-primary">
                    <div class="card-header">
                        ...
                        <span> <a style="color: #ffffff !important; font-weight: 500;"
                                href="{{route('AdminCategoriesStats')}}">View All</a> </span>
                    </div>


                    <div style="margin-top:1rem;max-height: 420px;
                    overflow-y: scroll;" class="card-body mb-0 stat_boxes">
                        @foreach($cats['data'] as $key => $value)
                        {{-- <span id="">{{$key}}</span> <span style="float: right;" id="">{{$value}} Coupons</span> --}}
                        <span id="">{{$value['name']}}</span> <span style="float: right;" id="">{{$value['active_deals']}} Deals</span>
        ...
        <div class="row">
            ...
            <div class="col-xl-6 col-xxl-4 col-sm-6">
                <div class="card overflow-hidden">
                    <div class="card-header">
                        {{-- {{url('MaleUsage')}} --}}
                        <h4 class="card-title"> <a href="{{url('maleUsageStat')}}">Male Usage</a> <br> <span>{{$getMaleData['totalGenderUsers']}} / {{$getMaleData['totalUsers']}}</span></h4>

                        <h4 class="card-title">{{round($getMaleData['genderUserPercentage'],0)}}%</h4>
                    </div>
                    ...
                    {{-- <div class="col-xl-6 col-lg-12 col-sm-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <canvas id="barChart_forMaleStat"></canvas>
                            </div>
                        {{-- </div>
                    </div> --}}
                    ...
                    {{-- <div class="card-body">
                        <div class="ico-sparkline">
                            <div id="sparkLineGraphForMaleUsage"></div>
                        </div>
                    </div> --}}
                </div>
            </div>
            ...
            <div class="col-xl-6 col-xxl-4 col-sm-6">
                <div class="card overflow-hidden">
                    <div class="card-header">
                        {{-- <h4 class="card-title">Female Usage <br> <span>15+ to 60+</span></h4>

                        <h4 class="card-title">80%</h4> --}}
                        <h4 class="card-title"><a href="{{url('femaleUsageStat')}}">Female Usage</a> <br> <span>{{$getFemaleData['totalGenderUsers']}} / {{$getFemaleData['totalUsers']}}</span></h4>

                        <h4 class="card-title">{{round($getFemaleData['genderUserPercentage'],0)}}%</h4>
                    </div>
                    ...
                    {{-- <div class="col-xl-6 col-lg-12 col-sm-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <canvas id="barChart_forFemaleStat"></canvas>
                            </div>
                        {{-- </div>
                    </div> --}}
                    ...
                    {{-- <div class="card-body">
                        <div class="ico-sparkline">
                            <div id="sparkLineGraphForFemaleUsage"></div>
                        </div>
                    </div> --}}
                </div>
            </div>
            ...
            {{-- <div class="col-xl-6 col-xxl-4 col-sm-6">
                <div class="card overflow-hidden">
                    <div class="card-header">
                        <h4 class="card-title">Male Usage <br> <span>15+ to 60+</span></h4>
...
{{-- <div class="content-body" style="min-height: 300px !important !important; padding-top: 0px !important;">
    <div class="container-fluid">
        <div class="row">
