                        ...
                        <div class="card avtivity-card">
                            <div class="card-body">
                                ...
                                <div class="media align-items-center">
                                    ...
                                    <div class="media-body">
                                        <p class="fs-14 mb-2">Total Active Coupons</p>
                                        <span
                        ...
                        <div class="card featuredMenu">
                            ...
                            <div class="card-body loadmore-content height750 dz-scroll pt-0" id="FeaturedMenusContent">
                                ...
                                <div class="media mb-4">
                                    {{-- <img src="{{'https://gigiapi.zanforthstaging.com/'.$D['images'][0]['path'].'/'.$D['images'][0]['image'].''}}" width="85" alt="" class="rounded mr-3"> --}}
                                ...
                                <ul class="d-flex flex-wrap pb-2 border-bottom mb-3 justify-content-between">
                                    <li class="mr-3 mb-2"><span class="fs-14 text-black"
                                            style="    font-size: 11px !important;">{{$D['totalRadeems']}} Coupons
                                            Redeemed </span></li>
            ...
            <div class="col-xl-4">
                <div class="card text-white bg-primary">
                    ...
                    overflow-y: scroll;" class="card-body mb-0 stat_boxes">
                        ...
                        <span id="">{{$value['name']}}</span> <span style="float: right;" id="">{{$value['active_deals']}} Coupons</span>
