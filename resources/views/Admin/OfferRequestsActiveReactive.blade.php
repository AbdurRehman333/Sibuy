                            ...
                            <div class="media border-bottom mb-3 pb-3 d-lg-flex d-block menu-list">
                                ...
                                <div class="media-body col-lg-8 pl-0">
                                    <h6 class="fs-16 font-w600"><a href="{{url('OfferDetails/'.$deal['id'])}}"
                                            ...
                                            @if($deal['activiation_request'] == 2)
                                            <button style="margin-left: 10px;" class="badge badge-sm badge-danger">Inactivation Request</button>
                                            @else
                                            <button style="margin-left: 10px;" class="badge badge-sm badge-primary">Reactivation Request</button>
                                            @endif
                                    ...
                                    <div class="">
                                        ...
                                        <div style="    text-align-last: center; margin-top:1rem;">
                                            <a href="{{url('takeActionOnDealActivation/'.$deal['id'])}}">
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form action="{{url('takeActionOnDealActivationReject',['id' => $deal['id']])}}" method="POST">
                                            @csrf
