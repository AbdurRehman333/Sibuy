<div class="chatbox" id="main_chatbox">
    ...
    <div class="custom-tab-1">
        ...
        <div class="tab-content">
            <div class="tab-pane fade active show" id="chat" role="tabpanel">
                <div class="card mb-sm-3 mb-md-0 contacts_card dz-chat-user-box" id="contacts_card">
                    ...
                    <div class="card-body contacts_body p-0 dz-scroll" id="DZ_W_Contacts_Body" id="ul_chatList_to_refresh">
                        <ul class="contacts">
                ...
                <div id="">
                    <div class="card chat dz-chat-history-box d-none " id="this_is_to_be_updated_on_convo_load">
                        <div class="card-header chat-list-header text-center">
                            <a href="javascript:void(0)" class="dz-chat-history-back" style="">
                ...
                $(document).on('click', '.send_button', function() {
                    ...
                    $.ajax({
                        ...
                        success: function(data) {
                            ...
                            // convo_list.innerHTML = data;
                            // contacts_card.innerHTML = data;
                        }
                    });
    ...
    <script>
            ...
            channel.bind('message.created', function(data) {
                ...
                {
                    // alert('it is it');
                    // console.log($("#new_msgs_be_here"));
                    // console.log(document.getElementById('new_msgs_be_here'));
                    // data = ""

                    // if(parseInt(user_id) == parseInt(from_listener_my_id))  //user_id
                    // {
