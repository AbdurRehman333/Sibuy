                ...
                <ul class="navbar-nav header-right">
                    <li class="nav-item">
                        <div class="input-group search-area d-xl-inline-flex d-none">
                            ...
                            <form action="{{url('MerchantSearchCoupons')}}"  method="GET" style="display: flex;">
                                {{-- @csrf --}}
                            ...
                            <div id="DZ_W_TimeLine11Home" class="widget-timeline dz-scroll style-1 p-3 height370 ps ps--active-y">
                                <ul class="timeline">
                                    ...
                                    @elseif($note['type'] == 'deal')
                                        ...
                                        @elseif($note['subject'] == 'Deal Approved')
                                        <li>
                                    ...
                                    <li style="text-align: center;">
                                        ...
                                        <a class="" href="{{url('MerchantAllNotifications')}}">
                    ...
                    <li class="nav-item dropdown header-profile">
                        <a class="nav-link" href="javascript:void(0)" role="button" data-toggle="dropdown">
                            ...
                            <div class="header-info">
                                ...
                                <p class="fs-12 mb-0">Sibuy Merchant</p>
                            </div>
                        </a>
                        <div class="dropdown-menu dropdown-menu-right">

                            <a href="{{url('MerchantSettings')}}" class="dropdown-item ai-icon">
                                <svg id="icon-user1" xmlns="http://www.w3.org/2000/svg" class="text-primary" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"></path><circle cx="12" cy="7" r="4"></circle></svg>
                                <span class="ml-2">Account Settings </span>
                            </a>

                            <form action="{{url('merchant_logout')}}" method="POST" style="margin-left:23px;">
