                                ...
                                <script>
                                    $(document).ready(function(){
                                        ...
                                        $("#profile_settings").click(function(){
                                            ...
                                            $('#setting_1NavItem').addClass('active');
                                            $('#setting_1').removeClass('importantRule');
                                            $('#setting_1').removeClass('fade');
                                            $('#setting_1').removeClass('in');

                                            $('#setting_3').addClass('in');
                                            $('#setting_3').addClass('fade');
                                            $('#setting_3').addClass('importantRule');
                                            $('#setting_3NavItem').removeClass('active');
                                            //others
                                ...
                                <div class="tab-content">
                                    <div class="tab-pane  show active" id="home1" role="tabpanel" style="">
                                        <div class="pt-4">
                                                                    ...
                                                                    <table id="example2" class="display" style="">
                                                                        {{-- <thead style="background:#d9d5d5"> --}}
                                                                            <thead style="background:#c5d9e7">
                                                                                <tr>
                                                                                    ...
                                                                                    <th>Deal Expiry Redemption</th>
                                                                                    {{-- <th>Discount</th>
                                                                                    <th>Additional Discount</th>
                                                                                    <th>Additional Discount Expiry</th> --}}
                                                                                    
                                                                                    <th>Manual Redemption Code</th>
                                                                                    {{-- <th>Actual Price</th>
                                                                        ...
                                                                        <tbody>
                                                                            ...
                                                                            <tr id="{{$key}}_Row_ID">
                                                                                ...
                                                                                <td>
                                                                                    <a href="{{url('discount_details/'.$deal['id'].'')}}"> {{$deal['name']}} </a>
                                                                                ...
                                                                                <td>{{''.$deal["purchase_id"].':'.$deal['purchase_quantity'].':'.$deal["discount_on_price"].':'.$deal["price"].':'.$deal["type"].':'.$deal["availability_status"].':'.$deal["name"].''}}</td>
                                            ...
                                            <script>
                                                ...
                                                $.ajax({
                                                    ...
                                                    success: function (data) {
                                                        ...
                                                        data: {
                                                            ...
                                                            dataType: 'html',
                                                            success: function (data) {
                                                                const myTimeout = setTimeout(qrCodeManual(data), 300);
                                                            }
                                                        });
                                                        ...
                                                        // alert(1);
                                                        const collection = new Array(name, merchant_name, price);
                                                ...
                                                function qrCodeManual(data) {
                                                    // alert(data);
                                                    html = `<p> QrCode :  ${data} </p>`;
                                                    $("#qrCodeManual").html(html);
                                                    // $("#qrCodeManual").html(data);
                                                }
                                            ...
                                            <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog"
                                                ...
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div id="qrCodeManual" style="    text-align: -webkit-center;">
                                                ...
                                                function showDataOnModal(data)
                                                    {
                                                        ...
                                                        // $("button").click(function(){
                                                            ...
                                                            <div style="text-align:center;">
                                                                ...
                                                                <h2> <b> Paid Price : </b> ${data[2]}AZN <h2>
                                    ...
                                    <div class="tab-pane fade" id="profile1" style="    margin-top: -50px;">
                                        ...
                                        <ul class="nav nav-tabs nav nav-pills mb-3 tabs_nav"
                                            ...
                                            <li class="nav-item" id="setting_1NavItem">
                                            ...
                                            <li class="nav-item" id="setting_3NavItem">
                                                    ...
                                                    <form method="POST" action="{{url('myAccountSettingApplied')}}" enctype="multipart/form-data">
                                                        ...
                                                        <div class="mb-3" style="margin-top: 12px;">
                                                            ...
                                                            text-align-last: center;">
                                                                @if(session()->get('Authenticated_user_data')['gender'] == 'male')
                                                                <option value="male" selected>Male</option>
                                                                <option value="female">Female</option>
                                                                <option value="other">Other</option>
                                                                @elseif(session()->get('Authenticated_user_data')['gender'] == 'female')
                                                                <option value="male">Male</option>
                                                                <option value="female" selected>Female</option>
                                                                <option value="other">Other</option>
                                                                @elseif(session()->get('Authenticated_user_data')['gender'] == 'other')
                                                                <option value="male">Male</option>
                                                                <option value="female">Female</option>
                                                ...
                                                <div class="pt-4">
                                                    ...
                                                    <div class=" pref_form"
                                                        ...
                                                        <form method="POST" action="{{url('UpdateCurrentLocation')}}">
                                                            ...
                                                            <label for="exampleInputEmail1"
                                                            class="form-label">Current Country Location</label>
                                                                 <select class="" id="country" name="country" style="width: 100%;text-align: center;padding: 13px;
                                                                 ...
                                                                 border-radius: 12px;">
                                                                    ...
                                                                    @if($country['id'] == session()->get('Authenticated_user_data')['userLocations'][0]['country'])
                                                            ...
                                                            @endphp
                                                             ...
                                                             <div class="mb-3" style="margin-top: 12px;">
                                                                  <label for="exampleInputEmail1"
                                                                  class="form-label">Your Current Location </label>
                                                                    <select class="citesSelect" id="city" name="city[]" multiple="multiple" style="
                                                                    ...
                                                                    {{-- <option value="{{$locations[0]['cityId']}}">{{$locations[0]['cityName']}}</option> --}}

                                                                    @foreach($CitiesOfUsersCountry as $key => $city)

                                                                    {{-- @if($city['id'] == session()->get('Authenticated_user_data')['userLocations'][0]['city']) --}}
                                                                    @if(in_array($city['id'],$CitiesOfUser))
                                                            ...
                                                            <div class="mb-3" style="margin-top: 12px;">
                                                                <label for="exampleInputEmail1"
                                                                    ...
                                                                    <input type="text"  value="{{session()->get('Authenticated_user_data')['userLocations'][0]['city']}}" class="form-control" name="city" id="cityProfile">
                                                                    <input type="hidden" value="{{session()->get('Authenticated_user_data')['userLocations'][0]['lat']}}" name="lat" id="lat">
                                                                    <input type="hidden" value="{{session()->get('Authenticated_user_data')['userLocations'][0]['long']}}" name="long" id="long">
                                                            </div>
                                                            <div class="mb-3" style="margin-top: 12px;">
                                                                <label for="exampleInputEmail1"
                                                                    class="form-label">Country</label>
                                                                    <input type="text" class="form-control" value="{{session()->get('Authenticated_user_data')['userLocations'][0]['country']}}" name="country" id="countryProfile">
                                                            </div> --}}
                                                ...
                                                <form method="POST" action="{{url('setPreferences')}}">
                                                    ...
                                                    <div class="mb-3" style="margin-top: 12px;">
                                                        <label for="exampleInputEmail1"
                                                            ...
                                                            <select class="js-example-basic-multiple form-control" id="prefSelect" style="width: 100%" name="preferences[]" multiple="multiple">

                                                                @foreach($categories as $key => $cat)
                                                                    {{-- <option value="{{$cat['id']}}">{{$cat['name']}}</option> --}}

                                                                    @if(in_array($cat['id'], $user_prefs))
                                                                    <option id="{{$cat['id']}}_option" value="{{$cat['id']}}" selected> {{$cat['name']}} </option>
                                                                    @else
                                                                    <option id="{{$cat['id']}}_option" value="{{$cat['id']}}"> {{$cat['name']}} </option>
                                                                    @endif
                                                    ...
                                                    <div style="margin-top: 10px;">Suggesstions : 
                                                        @foreach($categories as $key => $cat)
                                                        @php
                                                            $no = rand(1,3);
                                                        @endphp
                                                        @if($no == 1)
                                                        <button type="button" data-id="{{$cat['id']}}" class="btn btn-info prefBtn"> {{$cat['name']}} </button> &nbsp
                                                        @elseif($no == 2)
                                                        <button type="button" data-id="{{$cat['id']}}" class="btn btn-success prefBtn"> {{$cat['name']}} </button> &nbsp
                                                        @elseif($no == 3)
                                                        <button type="button" data-id="{{$cat['id']}}" class="btn btn-danger prefBtn"> {{$cat['name']}} </button> &nbsp
                                                        @endif
                                                    ...
                                                    <div style="margin-top: 10px;">Trending Tags: 


                                                        

                                                        @foreach($Trendingcategories as $key => $cat)
                                                    ...
                                                    <script>
                                                        $(".prefBtn").click(function(e){
                                                            ...
                                                            // $("#prefSelect").val(value).trigger('change');

                                                            // console.log()
                                                            id = $(`#${value}_option`).attr('selected', true);
                                                            $("#prefSelect").trigger('change');
                                                            console.log(id);
                                                            // $('#prefSelect')

                                                            // $('#prefSelect>option[value="' + value + '"]').prop('selected', true);

                                                            // $('#prefSelect').find('option:eq(3)').attr('selected', true);
                                                            // $('#prefSelect>option:eq(3)').attr('selected', true);
