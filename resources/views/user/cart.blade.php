                                ...
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="item_in_cart"> 
                                            ...
                                            {{-- <td data-id="{{$key}}">
                                                <button data-id="{{$key}}" id="dec" onclick="DEC(this)"
                                                    class="badge badge-info"> <span> - </span> </button>
                                                <span data-id="{{$key}}_qty"
                                                    id="{{$key}}_qty">{{$datum['quantity']}}</span>
                                                <button data-id="{{$key}}" id="inc" onclick="INC(this)"
                                                    class="badge badge-info"> <span> + </span> </button>
                                            </td> --}}

                                            <td id="{{$key}}_total" class="total_classes">${{$datum['total_price']}}
                                            </td>

                                            <td><a class="btn btn-danger" href="{{url('delete_from_cart/'.$datum['deal_id'])}}">Delete</a></td>
                                        </tr>
                                        @endforeach
                                    </tbody>
                                </table>
                                ...
                                <div style="font-size: 18px;    text-align: -webkit-center; margin-top:6rem;">
                                    ...
                                    <div class="card" style="width: 18rem;">
                                        ...
                                        <ul class="list-group list-group-flush">
                                            ...
                                            {{-- <li class="list-group-item"> <button class="btn btn-info" style="background: #96cbf1;">Proceed To Checkout</button> </li> --}}
...
@if(Session::has('success'))
<script>
    swal("Purchased!","{!! Session::get('success') !!}","success");
</script>
@endif
