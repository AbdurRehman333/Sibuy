                        ...
                        <div class="d-flex flex-column h-100">
                            ...
                            <div class="auth-content my-auto">
                                <div class="text-center">
                                    ...
                                    <p class="text-muted mt-2">You Have Received an Email With a Confirmation Code..</p>
                                ...
                                <form class="custom-form mt-4 pt-2" action="{{route('AccVerifyConfirm')}}" method="post">
                                    @csrf
                                    <div class="mb-3 ">
                                    ...
                                    <div class="mb-3 ">
                                        <label class="form-label" for="code">Enter Your Confirmation Code Here:</label>
                                        <input type="text" class="form-control" id="code" placeholder="Confirmation Code" name="code">
                                        <span class="text-danger"></span>
                                    </div>
                                    <div class="row mb-4">
